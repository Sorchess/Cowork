...
class PostNotFoundException(NabronirovalException):
    detail = "Post not found"


class PostNotFoundHTTPException(NabronirovalHTTPException):
    status_code = 404
    detail = "Post not found"


class CommentNotFoundException(NabronirovalException):
    detail = "Comment not found"


class CommentNotFoundHTTPException(NabronirovalHTTPException):
    status_code = 404
    detail = "Comment not found"
